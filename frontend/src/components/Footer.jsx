...
const Footer = () => {
  const footerLinks = {
    ...
    restaurants: [
      ...
      { name: 'Restaurant Login', href: '#login' },
      { name: 'Become a Driver', href: '#driver' },
      { name: 'Restaurant Support', href: '#support' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              restaurants in your area, ensuring fresh, hot meals delivered right to your doorstep.
            </p>
            ...
            <div className="flex space-x-4 mb-6">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-primary-600 transition-colors duration-300 transform hover:scale-110"
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="grid lg:grid-cols-2 gap-8">
            <div>
              <h4 className="font-semibold mb-4">Restaurant Partners</h4>
