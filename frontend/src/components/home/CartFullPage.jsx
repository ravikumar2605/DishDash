      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-md">Browse restaurants and add items to start your order.</p>
            <button onClick={handleBackToSidebar} className="btn-primary">Explore Restaurants</button>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="space-y-4">
                {cartItems.map((item) => (
                  <div key={`${item.restaurantId}-${item.name}`} className="bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-4">
                ...
                <div className="space-y-3">
                  ...
                  <button onClick={handleBackToSidebar} className="w-full btn-outline">Continue Shopping</button>
                </div>
