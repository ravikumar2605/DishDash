        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-primary-600 to-secondary-600">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-4 rounded-lg bg-white/20 hover:bg-white/30 text-white text-sm transition-colors duration-200"
            >
              <i
                class="fa-solid fa-expand fa-beat fa-2xl"
                style={{ color: "#ffffff" }}
              ></i>
            </button>
            <button
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex flex-col items-end space-y-2">
                          ...
                          <button
                            onClick={() =>
                              onRemoveItem(`${item.restaurantId}-${item.name}`)
                            }
